...
class Prompt(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_end", b"_end", "_server_time", b"_server_time", "end", b"end", "server_time", b"server_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_end", b"_end", "_server_time", b"_server_time", "end", b"end", "server_time", b"server_time", "text", b"text"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_end", b"_end"]) -> typing.Literal["end"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_server_time", b"_server_time"]) -> typing.Literal["server_time"] | None: ...
